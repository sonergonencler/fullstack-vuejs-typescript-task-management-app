    ...
    <div class="auth-content">
      ...
      <AppForm @submit.prevent="handleSubmit">
        ...
        <div class="form-field">
          <AppButton type="submit" primary full :disabled="!isValid">Signup</AppButton>
          <AppButton type="button" to="/login" link full>Login</AppButton>
        </div>
      </AppForm>
    </div>
  </div>
